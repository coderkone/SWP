...
CREATE TABLE [dbo].[Users](
    ...
    [email]         [varchar](120) NOT NULL UNIQUE,
    [password_hash] [varchar](255) NOT NULL,
    [role]          [varchar](20)  DEFAULT 'member',   -- validate trong Java
...
-- =============================================
-- 3. QUESTIONS
-- NOTE: accepted_answer_id is added via ALTER after Answers is created
--       to avoid a circular-cascade rejection by SQL Server.
-- =============================================
CREATE TABLE [dbo].[Questions](
    [question_id]       [bigint]        IDENTITY(1,1) PRIMARY KEY,
    [user_id]           [bigint]        NOT NULL,
...
-- Add accepted_answer_id after Answers exists (plain FK, no cascade to avoid cycle)
ALTER TABLE [dbo].[Questions]
    ADD [accepted_answer_id] [bigint] NULL
GO
ALTER TABLE [dbo].[Questions]
...
CREATE TABLE [dbo].[Votes](
    ...
    [question_id] [bigint]      NULL,
    [answer_id]   [bigint]      NULL,
    [vote_type]   [varchar](10) NOT NULL,   -- Java tự check "up" / "down"
    [created_at]  [datetime]    DEFAULT GETDATE(),
    CONSTRAINT [UQ_Votes_user_question_answer] UNIQUE ([user_id], [question_id], [answer_id]),
    FOREIGN KEY ([user_id])     REFERENCES [dbo].[Users]([user_id]),
    FOREIGN KEY ([question_id]) REFERENCES [dbo].[Questions]([question_id]) ON DELETE CASCADE,
...
CREATE TABLE [dbo].[Badges](
    [badge_id]            [bigint]        IDENTITY(1,1) PRIMARY KEY,
    [name]                [nvarchar](50)  NOT NULL UNIQUE,
    [type]                [varchar](10)   NOT NULL,   -- gold/silver/bronze
    [description]         [nvarchar](max) NULL,
    [required_reputation] [int]           DEFAULT 0
)
GO

...
<div class="wrap">
    ...
    <form method="post" action="<%=request.getContextPath()%>/auth/register">
        ...
        <input name="username" type="text" placeholder="e.g. John Doe" required value="<%=request.getParameter("username") != null ? request.getParameter("username") : ""%>">

        <label>Email</label>
        <input name="email" type="email" placeholder="you@example.com" required value="<%=request.getParameter("email") != null ? request.getParameter("email") : ""%>">

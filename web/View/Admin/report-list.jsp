...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-success { background-color: #2f6f44; color: white; }
        ...
        .status-open { color: #D0393E; background: #FDEDED; }
        ...
        .pagination a, .pagination span { padding: 8px 12px; border: 1px solid var(--border-color); border-radius: 4px; text-decoration: none; color: var(--text-main); font-size: 13px; }
        .pagination .active { background-color: var(--active-orange); color: white; border-color: var(--active-orange); }
        ...
        .note-cell { max-width: 250px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    </style>
</head>
<body>
